...
*/
    ...
    public static YahooCurrencyListModel getCurrency() {
        ...
        try {
            ...
            if (conn.getResponseCode() == 200) {
                ...
                try {
                    ...
                    //STORE JSON
                    Prefs.saveCurrencyJsonData(json);
        ...
        if (result == null || result.getCurrency() == null || result.getCurrency().size() == 0) { // IF NULL THEN GET MODEL FROM LOCAL
            try {
